...
type
  ...
  TRange = record
    ...
    function Ensured(const zone: TRange): TRange; overload; cdecl;
    function Ensure(const zone: TRange): Boolean; overload; cdecl;
    ...
    function Mean: Double; overload; cdecl;
    ...
    function Halved: Integer; overload; cdecl;
